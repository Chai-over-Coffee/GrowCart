  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen text-center p-6'>
        ...
        className='flex items-center gap-3'>
            ...
            <h1 className='text-4xl md:text-5xl font-extrabold text-green-700'>GrowCart</h1>
    ...
    initial = {{
        ...
        className='mt-1 text-gray-700 text-lg md:text-xl max-w-lg'>
            Groceries at your door, freshness at your fingertips.
    </motion.p>
    <motion.div initial = {{
            opacity: 0,
            scale: 0.9
